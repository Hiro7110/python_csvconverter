...
for row in csv_data:
    ...
    for i in row:
        ...
        if i == "null":
            ...
            right.append(original[index][selected_columns[index2]-1:selected_columns[index2+1]-1])
            left.append(original[index][selected_columns[index2]-1:selected_columns[index2+1]-1])
        elif i == right_code:
            right.append(original[index][selected_columns[index2]-1:selected_columns[index2+1]-1])
        elif i == left_code:
            left.append(original[index][selected_columns[index2]-1:selected_columns[index2+1]-1])
